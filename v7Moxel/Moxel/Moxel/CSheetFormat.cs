...
{
    [Serializable]
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Ansi, Pack = 1, Size = 30)]
    unsafe public struct CSheetFormat
    {
        [FieldOffset(0x00)]
        ...
        public static CSheetFormat Empty = new CSheetFormat
        {
            dwFlags = 0,
            wShow = 0,
            wColumnPosition = 0,
        ...
        private static byte[] ToBytes(CSheetFormat format)
        {
